...
CREATE TABLE IF NOT EXISTS `alignments` (
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY `UK_axdq4kxh1okmrbb29ihi2m3ql` (`nature`)
...
CREATE TABLE IF NOT EXISTS `ideals` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `alignment` varchar(60) DEFAULT NULL,
    `name` varchar(60) DEFAULT NULL,
    PRIMARY KEY (`id`),
    UNIQUE KEY `UK_oghrd317p17c85yhbu3jynrxy` (`name`)
...
CREATE TABLE IF NOT EXISTS `occupations` (
    `id` bigint NOT NULL AUTO_INCREMENT,
    `name_female` varchar(100) COLLATE utf8mb4_polish_ci DEFAULT NULL,
    `name_male` varchar(100) COLLATE utf8mb4_polish_ci DEFAULT NULL,
    PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `useful_knowledge` (
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY `UK_fltevu6n1wy8i8bgy3lqp8dxu` (`description`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci;
